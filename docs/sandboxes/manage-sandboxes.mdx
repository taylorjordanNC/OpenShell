...
Large stdout and stderr streams are delivered before a successful exit. If an
output attachment cannot keep up or stops making progress, `exec` fails instead
of reporting success with incomplete output.
