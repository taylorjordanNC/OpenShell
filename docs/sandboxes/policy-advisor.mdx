...
3. OpenShell validates the proposal and checks it for added risk in two ways.
   ...
   sandbox could reach with and without the rule. OpenShell also flags destinations that are often risky, such as
   ...
   Refer to [Proposal Risk Check](#proposal-risk-check).
...
rule. The check accounts for the credentials of
