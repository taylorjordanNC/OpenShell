...
can change while it runs, as described in [How Changes Take
Effect](/sandboxes/manage-policies#how-changes-take-effect). The [Policy Schema
Reference](/reference/policy-schema)
